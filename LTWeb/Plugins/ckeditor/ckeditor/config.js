...
CKEDITOR.editorConfig = function (config) {
    ...
    config.filebrowserBrowseUrl = '/Plugins/ckfinder/ckfinder/ckfinder.html';
    config.filebrowserImageUrl = '/Plugins/ckfinder/ckfinder.html?Type=Images';
    config.filebrowserFlashUrl = '/Plugins/ckfinder/ckfinder.html?Type=Flash';
